...
const Dashboard = () => {
  ...
  const chartData = {
    ...
    options: {
      ...
      // ... (other chart options)
      // Add all the other options from the plain JavaScript chart here
    },
  };
            ...
            <div className="d-flex align-items-end row">
              ...
              <div className="col-sm-5 text-center text-sm-left">
                <div className="card-body pb-0 px-0 px-md-4">
                  <img
                    src="main/assets/img/illustrations/man-with-laptop-light.png"
                    height="140"
                    alt="View Badge User"
                ...
                <div className="card-body">
                  <div className="card-title d-flex align-items-start justify-content-between">
                    <div className="avatar flex-shrink-0">
                      <img
                        src="main/assets/img/icons/unicons/chart-success.png"
                        alt="chart success"
                        className="rounded"
                      />
                    </div>
              ...
              <div className="card">
                <div className="card-body">
                  <div className="card-title d-flex align-items-start justify-content-between">
                    <div className="avatar flex-shrink-0">
                      <img
                        src="main/assets/img/icons/unicons/wallet-info.png"
                        alt="Credit Card"
                        className="rounded"
                      />
                    </div>
              ...
              <div className="card">
                <div className="card-body">
                  <div className="card-title d-flex align-items-start justify-content-between">
                    <div className="avatar flex-shrink-0">
                      <img
                        src="main/assets/img/icons/unicons/paypal.png"
                        alt="Credit Card"
                        className="rounded"
                      />
                    </div>
              ...
              <div className="card">
                <div className="card-body">
                  <div className="card-title d-flex align-items-start justify-content-between">
                    <div className="avatar flex-shrink-0">
                      <img
                        src="main/assets/img/icons/unicons/cc-primary.png"
                        alt="Credit Card"
                        className="rounded"
                      />
                    </div>
              ...
              <div className="tab-content p-0">
                ...
                >
                  <div className="d-flex p-4 pt-3">
                    <div className="avatar flex-shrink-0 me-3">
                      <img
                        src="main/assets/img/icons/unicons/wallet.png"
                        alt="User"
                      />
                    </div>
                    <div>
            ...
            <div className="card-body">
              <ul className="p-0 m-0">
                ...
                <li className="d-flex mb-4 pb-1">
                  <div className="avatar flex-shrink-0 me-3">
                    <img
                      src="main/assets/img/icons/unicons/chart.png"
                      alt="User"
                      className="rounded"
                    />
                  </div>
                ...
                <li className="d-flex mb-4 pb-1">
                  <div className="avatar flex-shrink-0 me-3">
                    <img
                      src="main/assets/img/icons/unicons/cc-success.png"
                      alt="User"
                      className="rounded"
                    />
                  </div>
                ...
                <li className="d-flex">
                  <div className="avatar flex-shrink-0 me-3">
                    <img
                      src="main/assets/img/icons/unicons/cc-warning.png"
                      alt="User"
                      className="rounded"
                    />
                  </div>
